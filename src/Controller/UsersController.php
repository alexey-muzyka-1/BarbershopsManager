...
class UsersController extends AbstractController
{
    ...
    {
        if ($this->changeYourselfCheck($user)) {
    ...
    public function changeYourselfCheck(User $user): bool
    {
        if ($user->getId()->getValue() === $this->getUser()->getId()) {
            $this->addFlash('error', UserErrorConstants::USER_CHANGE_ROLE_FOR_YOURSELF);
